...
static GstV4L2FormatDesc gst_v4l2_formats[] = {
  ...
  {MAP_FMT (RFC, NV12),                         KNOWN_DRM_MAP,                      GST_V4L2_RAW},
  ...
  {MAP_FMT (NV12M_8L128, NV12_8L128),           KNOWN_DRM_MAP,                      GST_V4L2_RAW},
  {MAP_FMT (NV12M_10BE_8L128, NV12_10BE_8L128), KNOWN_DRM_MAP,                      GST_V4L2_RAW},
  {MAP_FMT (NV12_10BIT, NV12_10LE40),           KNOWN_DRM_MAP,                      GST_V4L2_RAW},
  {MAP_FMT (NV12X, NV12_10LE40),                KNOWN_DRM_MAP,                      GST_V4L2_RAW},
  {MAP_FMT (RFCX, NV12_10LE40),                 KNOWN_DRM_MAP,                      GST_V4L2_RAW},
    ...
    GstVideoInfoDmaDrm * info)
{
  ...
  if (r) {
    ...
    align.padding_right = (gint) width - (gint) r->width - r->left + crop_width;
    align.padding_bottom =
    ...
    GST_INFO_OBJECT (v4l2object->dbg_obj,
        ...
        align.padding_left, align.padding_right, align.padding_top,
        align.padding_bottom);
  }
